...
export const services3 = [
  {
    ...
    description:
      "Develop and deploy secure smart contracts across multiple blockchain platforms.",
    delay: 0,
  },
  {
    ...
    description:
      "Build highly scalable and secure decentralized finance (DeFi) platforms and protocols.",
    delay: 100,
  },
  {
    icon: "feather-image",
    ...
    description:
      "Create efficient and flexible non-fungible token (NFT) ecosystems for businesses.",
    delay: 200,
  },
  {
    icon: "feather-lock",
    title: "ZK Technology",
    description:
      "Implement advanced zero-knowledge proof systems to enhance privacy and security.",
    delay: 100,
  },
  {
    icon: "feather-layers",
    ...
    description:
      "Design and deploy decentralized applications across Ethereum, Polygon, and Solana.",
    delay: 150,
  },
  {
    ...
    description:
      "Provide smart contract audits and advanced blockchain security solutions.",
    delay: 200,
  },
];
